...
export const shouldSubmit = ( passwordRef, password2Ref) => {

    const inputs = [ passwordRef, password2Ref]; // declaração do array de inputs, para o forEach seja possível

    removeErrorClass( passwordRef, password2Ref); // antes das validações, as classes de erro são removidas
    ...
    checkForEmpty( passwordRef, password2Ref); // checa se existe algum campo vazio
