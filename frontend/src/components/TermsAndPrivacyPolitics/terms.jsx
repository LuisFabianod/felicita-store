...
export const Terms = () => {
    return (
            <body>
                <main>
                    <div class="section">
                        <h2 class="section-title">TERMOS DE USO — Felicita</h2>
                        <div class="section-content">
                            <p>– Felicita, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site <a href="https://www.felicitapijamaria.com.br">https://www.felicitapijamaria.com.br</a> e qualquer outro site, loja ou aplicativo operado pelo proprietário.</p>
                    ...
                    <div class="section">
                        <h2 class="section-title">Seção 1 - Usuário</h2>
                        <div class="section-content">
                    ...
                    <div class="section">
                        <h2 class="section-title">Seção 2 - Adesão em conjunto com a Política de Privacidade</h2>
                        <div class="section-content">
                            <p>– A utilização deste website acarreta a adesão aos presentes Termos de Uso e a versão mais atualizada da Política de Privacidade de Felicita.</p>
                        </div>
                    </div>

                    <div class="section">
                        <h2 class="section-title">Seção 3 - Condições de acesso</h2>
                        <div class="section-content">
                            <p>– Em geral, o acesso ao website da Felicita possui caráter gratuito e não exige prévia inscrição ou registro.</p>
                            ...
                            <p>– Partes deste website oferecem ao usuário a opção de publicar comentários em determinadas áreas. Felicita não consente com a publicação de conteúdos que tenham natureza discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de autor ou quaisquer outros direitos de terceiros.</p>
                            <p>– A publicação de quaisquer conteúdos pelo usuário deste website, incluindo mensagens e comentários, implica em licença não-exclusiva, irrevogável e irretratável, para sua utilização, reprodução e publicação pela Felicita no seu website, plataformas e aplicações de internet, ou ainda em outras plataformas, sem qualquer restrição ou limitação.</p>
                        </div>
                    </div>

                    <div class="section">
                        <h2 class="section-title">Seção 4 - Cookies</h2>
                        <div class="section-content">
                            ...
                            <p>– Também coletamos informações estatísticas sobre o uso do website para aprimoramento contínuo do nosso design e funcionalidade, para entender como o website é utilizado e para auxiliá-lo a solucionar questões relevantes.</p>
                    ...
                    <div class="section">
                        <h2 class="section-title">Seção 5 - Propriedade Intelectual</h2>
                        <div class="section-content">
                            <p>– Todos os elementos de Felicita são de propriedade intelectual da mesma ou de seus licenciados. Estes Termos ou a utilização do website não concede a você qualquer licença ou direito de uso dos direitos de propriedade intelectual da Felicita ou de terceiros.</p>
                        </div>
                    </div>

                    <div class="section">
                        <h2 class="section-title">Seção 6 - Links para sites de terceiros</h2>
                        <div class="section-content">
                            ...
                            <p>– Não nos responsabilizamos pelas políticas e práticas de coleta, uso e divulgação (incluindo práticas de proteção de dados) de outras organizações, tais como Facebook, Apple, Google, Microsoft, ou de qualquer outro desenvolvedor de software ou provedor de aplicativo, loja de mídia social, sistema operacional, prestador de serviços de internet sem fio ou fabricante de dispositivos, incluindo todos os Dados Pessoais que divulgar para outras organizações por meio dos aplicativos, relacionadas a tais aplicativos, ou publicadas em nossas páginas em mídias sociais.</p>
                            <p>– Nós recomendamos que você se informe sobre a política de privacidade e termos de uso de cada site visitado ou de cada prestador de serviço utilizado.</p>
                        </div>
                    </div>

                    <div class="section">
                        <h2 class="section-title">Seção 7 - Prazos e alterações</h2>
                        <div class="section-content">
                            <p>– O funcionamento deste website se dá por prazo indeterminado.</p>
                            <p>– O website no todo ou em cada uma das suas seções, pode ser encerrado, suspenso ou interrompido unilateralmente por Felicita, a qualquer momento e sem necessidade de prévio aviso.</p>
                        </div>
                    </div>

                    <div class="section">
                        <h2 class="section-title">Seção 8 - Dados pessoais</h2>
                        <div class="section-content">
                            <p>– Durante a utilização deste website, certos dados pessoais serão coletados e tratados por Felicita e/ou pelos Parceiros. As regras relacionadas ao tratamento de dados pessoais de Felicita estão estipuladas na Política de Privacidade.</p>
                        </div>
                    </div>

                    <div class="section">
                        <h2 class="section-title">Seção 9 - Contato</h2>
                        <div class="section-content">
                            <p>– Caso você tenha qualquer dúvida sobre os Termos de Uso, por favor, entre em contato pelo e-mail <a href="mailto:felicita@felicitapijamaria.com.br">felicita@felicitapijamaria.com.br</a>.</p>
                        </div>
                    </div>
                </main>
